...
bound of $705$ in Morpion 5T was proved in $2006$ in \cite[Demaine et al.]{demaine} using a careful geometric analysis of moves in Morpion 5T and an argument based
...
\item a geometric analysis of Morpion 5D led in \cite[Kawamura et al.]{japonczycy} to an upper bound of $121$ which improved on an earlier bound of $144$ found in \cite{demaine} using the potential method; considering a generalization of Morpion 5D, in this paper we prove an upper bound of $84$ on the length of Morpion 5D sequences;
