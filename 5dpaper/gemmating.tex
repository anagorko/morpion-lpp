...
\begin{proof}
\todo{Lemma 16 and 17 looks a bit suspicious as a pair}
In this Lemma we specifically use information about the structure of a move in Morpion 5D. Namely, in the linear program mentioned in the procedure we require that there 
