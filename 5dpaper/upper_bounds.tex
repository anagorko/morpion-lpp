...
Morpion 5D graph, but additionally we also require that the graph is {\em acyclic}. \todo{Explain what is acyclity - covered in a Lemma}
...
The proof is analogous to the proof of Theorem \ref{thm:boxes}. 
