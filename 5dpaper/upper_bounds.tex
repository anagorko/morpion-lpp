...
% \end{proof}
In order to prove Theorem \ref{thm:boxes} we apply the process described in Section \ref{sec:gemmating} to produce all bounding boxes relevant 
...
Morpion 5D graph, but additionally we also require that the graph is {\em acyclic}. \todo{Explain what is acyclic}
